    ...
    template: `
        <div class="px-4 pt-2">
            <div class="flex items-center gap-2">
                <div class="flex-1 flex items-center gap-2 overflow-x-auto whitespace-nowrap app-hide-scrollbar">
...
export class AppTabsbar {
    ...
    readonly canCloseAll = computed(() => this.tabsService.tabs().some((t) => t.closable));
